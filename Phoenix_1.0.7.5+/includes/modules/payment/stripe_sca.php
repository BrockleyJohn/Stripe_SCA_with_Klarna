...
class stripe_sca {
    ...
    var $code, $title, $description, $enabled, $intent, $api_version = '2019-08-14';

    function __construct() {
        global $PHP_SELF, $order, $payment;

        $this->signature = 'stripe|stripe_sca|1.0.16|2.3';
        $this->api_version = '2019-08-14';
    ...
    function confirmation() {
        global $oscTemplate, $cartID, $cart_Stripe_SCA_ID, $api_version, $customer_id, $languages_id, $order, $currencies, $currency, $stripe_payment_intent_id, $order_total_modules, $shipping, $insert_id;
        ...
        if (tep_session_is_registered('cartID')) {
            ...
            if (tep_session_is_registered('cart_Stripe_SCA_ID')) {
                ...
                if (($curr['currency'] != $order->info['currency']) || ($cartID != substr($cart_Stripe_SCA_ID, 0, strpos($cart_Stripe_SCA_ID, '-')))) {
        ...
        $content .= '<div id="stripe_table_new_card">' .
                ...
                '<div class="form-group"><label for="card-element" class="control-label">' . MODULE_PAYMENT_STRIPE_SCA_CREDITCARD_TYPE . '</label>' .
...
EOD;
        ...
        $params = array('MODULE_PAYMENT_STRIPE_SCA_STATUS' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_STATUS_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_STATUS_DESC,
                'value' => 'True',
                'set_func' => 'tep_cfg_select_option(array(\'True\', \'False\'), '),
            'MODULE_PAYMENT_STRIPE_SCA_TRANSACTION_SERVER' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_SERVER_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_SERVER_DESC,
                'value' => 'Live',
                'set_func' => 'tep_cfg_select_option(array(\'Live\', \'Test\'), '),
            'MODULE_PAYMENT_STRIPE_SCA_LIVE_PUBLISHABLE_KEY' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_LIVE_PUB_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_LIVE_PUB_DESC,
                'value' => ''),
            'MODULE_PAYMENT_STRIPE_SCA_LIVE_SECRET_KEY' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_LIVE_SECRET_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_LIVE_SECRET_DESC,
                'value' => ''),
            'MODULE_PAYMENT_STRIPE_SCA_LIVE_WEBHOOK_SECRET' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_LIVE_WEBHOOK_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_LIVE_WEBHOOK_DESC,
                'value' => ''),
            'MODULE_PAYMENT_STRIPE_SCA_TEST_PUBLISHABLE_KEY' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TEST_PUB_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TEST_PUB_DESC,
                'value' => ''),
            'MODULE_PAYMENT_STRIPE_SCA_TEST_SECRET_KEY' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TEST_SECRET_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TEST_SECRET_DESC,
                'value' => ''),
            'MODULE_PAYMENT_STRIPE_SCA_TEST_WEBHOOK_SECRET' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TEST_WEBHOOK_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TEST_WEBHOOK_DESC,
                'value' => ''),
            'MODULE_PAYMENT_STRIPE_SCA_TOKENS' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TOKENS_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TOKENS_DESC,
                'value' => 'False',
                'set_func' => 'tep_cfg_select_option(array(\'True\', \'False\'), '),
            'MODULE_PAYMENT_STRIPE_SCA_LOG' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_LOG_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_LOG_DESC,
                'value' => 'False',
                'set_func' => 'tep_cfg_select_option(array(\'True\', \'False\'), '),
            'MODULE_PAYMENT_STRIPE_SCA_TRANSACTION_METHOD' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_METHOD_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_METHOD_DESC,
                'value' => 'Authorize',
                'set_func' => 'tep_cfg_select_option(array(\'Authorize\', \'Capture\'), '),
            'MODULE_PAYMENT_STRIPE_SCA_PREPARE_ORDER_STATUS_ID' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_NEW_ORDER_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_NEW_ORDER_DESC,
                'value' => $prepare_status_id,
                'use_func' => 'tep_get_order_status_name',
                'set_func' => 'tep_cfg_pull_down_order_statuses('),
            'MODULE_PAYMENT_STRIPE_SCA_ORDER_STATUS_ID' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_PROCESSED_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_PROCESSED_DESC,
                'value' => '0',
                'use_func' => 'tep_get_order_status_name',
                'set_func' => 'tep_cfg_pull_down_order_statuses('),
            'MODULE_PAYMENT_STRIPE_SCA_TRANSACTION_ORDER_STATUS_ID' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TRANSACTION_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_TRANSACTION_DESC,
                'value' => $status_id,
                'set_func' => 'tep_cfg_pull_down_order_statuses(',
                'use_func' => 'tep_get_order_status_name'),
            'MODULE_PAYMENT_STRIPE_SCA_ZONE' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_ZONE_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_ZONE_DESC,
                'value' => '0',
                'use_func' => 'tep_get_zone_class_title',
                'set_func' => 'tep_cfg_pull_down_zone_classes('),
            'MODULE_PAYMENT_STRIPE_SCA_VERIFY_SSL' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_SSL_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_SSL_DESC,
                'value' => 'True',
                'set_func' => 'tep_cfg_select_option(array(\'True\', \'False\'), '),
            'MODULE_PAYMENT_STRIPE_SCA_PROXY' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_PROXY_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_PROXY_DESC),
            'MODULE_PAYMENT_STRIPE_SCA_DEBUG_EMAIL' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_EMAIL_TITLE,
                'desc' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_EMAIL_DESC),
            'MODULE_PAYMENT_STRIPE_SCA_SORT_ORDER' => array('title' => MODULE_PAYMENT_STRIPE_SCA_ADMIN_SORT_TITLE,
